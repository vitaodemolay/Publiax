        ...
        return (
            ...
            <Container className="container-sidebar">
                <ListGroup>
                    ...
                    <ListGroupItem tag="a" href="#/curriculum/DadosEscolaridade" ><span className="lnr lnr-graduation-hat"></span>Escolaridade</ListGroupItem>
                ...
                <ListGroup>
                    <ListGroupItem tag="a" href="#/curriculum/Apresentacao" ><span className="lnr lnr-eye"></span>Visualizar</ListGroupItem>
                    <ListGroupItem tag="a" href="#/curriculum/Apresentacao" ><span className="lnr lnr-printer"></span>Imprimir</ListGroupItem>
                </ListGroup>

                <ListGroup>
                    <h1 className="">Minha Conta</h1>
                    <ListGroupItem tag="a" href="#/curriculum/Apresentacao" ><span className="lnr lnr-users"></span>Curriculo</ListGroupItem>
                    <ListGroupItem tag="a" href="#/curriculum/Apresentacao" ><span className="lnr lnr-alarm"></span>Avisos</ListGroupItem>
                    <ListGroupItem tag="a" href="#/curriculum/Apresentacao" ><span className="lnr lnr-exit-up"></span>Participações</ListGroupItem>
                    <ListGroupItem tag="a" href="#/curriculum/Apresentacao" ><span className="lnr lnr-cog"></span>Configurações</ListGroupItem>
                </ListGroup>
            </Container>
